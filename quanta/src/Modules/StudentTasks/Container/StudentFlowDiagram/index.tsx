...
const StudentFlowDiagram = () => {

  const dispatch = useDispatch();
  const { goTo, goBack } = useNavigation()

  const { getStudentTaskDetails, studentWrittenQuestion, studentProcedureData, addStudentTaskResponseId, studentProgramData, studentFlowDiagramData } = useSelector(
  ...
  const getGuestTaskDetails = () => {
    ...
    dispatch(fetchTaskDetails({ //getTaskMetaDetails
      ...
      onSuccess: (success) => () => {
        ...
        // setFlowDiagramImage
        console.log("rrrrrrrrrrrr", studentFlowDiagramData);
