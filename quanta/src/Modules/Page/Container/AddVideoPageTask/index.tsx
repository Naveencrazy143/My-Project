...
import { AddVideoPageTaskProps } from './interface'
import { useSelector } from 'react-redux';
import { translate } from '@I18n';
import { SERVER } from '@Services';

const AddVideoPageTask = ({ onChangeTitle, onChangeDescription, handleFileSelect, onChangeUrl, onClick, titleValue, imageBs64, descriptionValue, urlValue, isLoading, responseImage, referenceName, onChangeReferenceName }: AddVideoPageTaskProps) => {
