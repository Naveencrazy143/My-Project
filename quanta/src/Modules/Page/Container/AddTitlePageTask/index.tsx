...
import { AddTitlePageTaskProps } from './interface'
import { ROUTES } from '@Routes'
import { useNavigation } from '@Hooks'
import { useSelector } from 'react-redux'
import { translate } from '@I18n'

const AddTitlePageTask = ({ titleValue, onChangeTitle, descriptionValue, onChangeDescription, onClick, isLoading, referenceName, onChangeReferenceName }: AddTitlePageTaskProps) => {
