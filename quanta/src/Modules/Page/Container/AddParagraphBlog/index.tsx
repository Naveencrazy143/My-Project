...
import { AddParagraphBlogProps } from './interface'
import { useSelector } from 'react-redux';
import { translate } from '@I18n';

const AddParagraphBlog = ({ titleValue, onChangeTitle, descriptionValue, onChangeDescription, onClick, isLoading, referenceName, onChangeReferenceName }: AddParagraphBlogProps) => {
