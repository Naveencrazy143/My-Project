export const icons = {
  ...
  deleteGrey: require('./Delete/deleteGrey.png'),
  ...
  upload: require('./Upload/cloud-computing.png'),
  excel: require('./Excel/excel.png'),
  ...
  javascript: require('./DefaultImage/JavaScript-logo.png'),

  badge: require('./Badge/badge.png'),
  badgeRed: require('./Badge/badgeRed.png'),
  badgeGreen: require('./Badge/badgeGreen.png'),

  upArrow: require('./DropdownUpArrow/upArrow.png'),
  forwardArrow: require('./ForwardArrow/right-arrows.png'),
  ...
  remove: require('./Remove/remove.png'),
  softwareDev: require('./SoftwareDev/software.png'),
  video: require('./Video/video.png'),
  linkedIn: require('./LinkedIn/linkedin.png'),
  page: require('./Page/page.png'),
  mockInterview: require('./MockInterview/mockInterview.png'),
  timeline: require('./Timeline/timeline.png'),
  calendarAmigo: require('./CalendarAmigo/CalendarAmico.png'),
  startUpLife: require('./StartupLife/icon.png'),
  videoImg: require('./VideoImg/icon.png')
};
