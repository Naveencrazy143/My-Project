...
const AddListBlog = ({ titleValue, onChangeTitle, descriptionValue, onChangeDescription, onClick, value, onSubmit, isLoading, referenceName, onChangeReferenceName }: AddParagraphBlogProps) => {
