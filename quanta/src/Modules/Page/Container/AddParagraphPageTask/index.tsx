...
const AddParagraphPageTask = ({ titleValue, onChangeTitle, descriptionValue, onChangeDescription, onClick, isLoading, referenceName, onChangeReferenceName }: AddParagraphPageTaskProps) => {
