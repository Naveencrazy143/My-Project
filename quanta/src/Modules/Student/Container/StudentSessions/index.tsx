import { Button, CommonTable, Divider, InputHeading, NoRecordsFound, ProgressBar, showToast } from '@Components'
...
import { Card, CardBody, CardHeader, CardImg, Col, ListGroup, ListGroupItem, Row, Spinner } from 'reactstrap'
import { StudentSessionsProps } from './interface'


function StudentSessions({ title }: StudentSessionsProps) {
    ...
    console.log("scheduledVideoCallData", scheduledVideoCallData)
    ...
    console.log("qqqqqqqqqqqqq", scheduledVideoCallData);
            ...
            <div className='row'>
                {<div className='col-sm-12'>
                    {getScheduledList.loader ?
                        ...
                        :
                        <Card style={{ height: dynamicHeight.dynamicWidth <= 1400 ? dynamicHeight.dynamicHeight - 30 : dynamicHeight.dynamicHeight - 95 }}>
                                                    ...
                                                    <div className={`checklist-item ${el.is_completed ? "checklist-item-danger checklist-item-checked" : "checklist-item-success "} `}>
                                                        ...
                                                        <div>
                                                            {!el.is_completed ? (
                                                                ...
                                                                <h5 className='text-green'>{'Completed'}</h5>
                                                            )}
                                                        </div>
                                                    </div>
                                                </ListGroupItem>
