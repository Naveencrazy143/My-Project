...
import { AddMarkDownBlogProps } from './interface'
import { Form } from 'reactstrap'
import { useState } from 'react';

const AddMarkDownBlog = ({ titleValue, onChangeTitle, onChangeQuill, quillValue, descriptionValue, onChangeDescription, onClick, isLoading }: AddMarkDownBlogProps) => {
