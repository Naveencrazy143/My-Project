...
import { AddImagePageTaskProps } from './interface'
...
const AddImagePageTask = ({ onChangeTitle, titleValue, descriptionValue, onChangeDescription, onClick, handleFileSelect, alt, isLoading, imageBs64, responseImage, referenceName, onChangeReferenceName, onChangeSize, imageSizeValue }: AddImagePageTaskProps) => {
